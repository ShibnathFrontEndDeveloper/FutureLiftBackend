    ...
    <div class="container sign-in-mode">
      <div class="forms-container">
        <div class="signin-signup">
          <form action="{{url('/forgetPasswordSubmit')}}" class="sign-in-form" method="post">
            @csrf
            <h2 class="title">Forget Password</h2>
            <div class="input-field">
              <i class="fas fa-envelope"></i>
              <input type="email" name="email" value="{{old('email')}}" placeholder="Enter Register Email" required autocomplete="off"/>
            </div>
