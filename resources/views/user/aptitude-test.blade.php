          ...
          <div class="container">
            <div class="row align-items-center personalityBanner_box_row">
              <div class="col-md-6">
                ...
                <p>Aptitude improves chances of success...</p>
                  <p>
                    Aptitude Test help you to understand your interest and strengths
                    area.
                  </p>
              ...
              <div class="col-md-6 ">
                <div class="personalityBannerImg">
                  <img src="{{asset('assets/images/aptitudetestBanner.png')}}" alt="" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="BenefitsCards swiper-wrapper">
            <div class="BenefitsCard swiper-slide">
              <div class="BenefitsCardContent" id="BenefitsCardContent-1">
                <p>SWOT Analysis</p>
                <p>
                  Gain insight as to which career to choose based on their
            ...
            <div class="BenefitsCard swiper-slide">
              <div class="BenefitsCardContent" id="BenefitsCardContent-2">
                ...
                <p>
                  Gain evaluation of a particular trait on based you get hired.
                </p>
              </div>
            </div>
            <div class="BenefitsCard swiper-slide">
              <div class="BenefitsCardContent" id="BenefitsCardContent-3">
                ...
                <p>
                  Gain the confidence to Handel any particular situation with
                  quick fair judgement.
                </p>
              </div>
            </div>
            <div class="BenefitsCard swiper-slide">
              <div class="BenefitsCardContent" id="BenefitsCardContent-4">
                <p>Natural talent</p>
                <p>
                  Gain potential that assist to learn a task naturally, easily
                  and swiftly .
                </p>
              </div>
            </div>
            <div class="BenefitsCard swiper-slide">
              <div class="BenefitsCardContent" id="BenefitsCardContent-5">
                <p>Save time</p>
                <p>
                  Gain the focusing on your relevant mental abilities and save
                  time.
                </p>
              </div>
            </div>
