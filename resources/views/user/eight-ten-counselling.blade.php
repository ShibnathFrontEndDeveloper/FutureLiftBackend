      ...
      <div class="container-fluid">
        <div class="banner container-fluid mt-5">
          ...
          <div class="Counselling8th-bannerContent col-6">
            ...
            <p>Choose Right Stream in Right Time.</p>
          ...
          >
            <div class="successSection8th-card col-6 col-md-3">
              <div class="successSection8th-cardContent">
                ...
                <a class="successSection8th-cardbtn px-1" href="{{url('/login-signup')}}">Get Started</a>
              </div>
            </div>
            <div class="successSection8th-card col-6 col-md-3">
              <div class="successSection8th-cardContent">
            ...
            <div class="successSection8th-card col-6 col-md-3">
              <div class="successSection8th-cardContent">
                ...
                <a class="successSection8th-cardbtn px-1" href="{{url('/login-signup')}} ">Know More</a>
              </div>
            </div>
          </div>
        </div>
