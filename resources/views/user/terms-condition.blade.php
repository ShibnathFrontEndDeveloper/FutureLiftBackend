...
<html lang="en">
  ...
  <body>
    <div class="main-container">
      ...
      <div class="whoWeAre_box_text">
        <div class="container">
            <p>These terms and conditions outline the rules and regulations for the use of Future Lift's Website, located at https;//futurelift.in/.
          ...
          <p id="lisence">
            <strong>License</strong><br><br>
                ...
                You must not:<br>
                •	Republish material from www.futurelift.in<br>
                •	Sell, rent or sub-license material from www.futurelift.in<br>
                •	Reproduce, duplicate or copy material from www.futurelift.in<br>
                •	Redistribute content from www.futurelift.in
          ...
          <p id="content">
            <strong>Hyperlinking to our Content</strong><br><br>
          ...
          <p id="iframe">
            <strong>Iframes</strong><br><br>
            Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.

          </p>
          <p id="content_Liability">
