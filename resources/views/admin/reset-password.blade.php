	    ...
	    <div class="row">
	        <div class="col-lg-6">
	            <span class="left-lotte"><script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
                            <lottie-player src="https://assets-v2.lottiefiles.com/a/2952eaa8-116d-11ee-8ea0-0b80ee2e8fa2/Z0j3D6OEI2.json"  background="transparent"  speed="1"  style="width: 512px; height: 512px;"  loop  autoplay></lottie-player>
                                    </span>
	        </div>
			...
			<div class="user_card">
				...
				<div class="<?=(request()->input('otp'))?'':'d-flex'?> justify-content-center form_container main-form" style="<?=(request()->input('otp'))?'display:none':'display:block'?>">
					<form name="login-form" action="{{url('/admin/newPasswordSubmitAdmin')}}" method="post">
						@csrf
						...
						<div class="input-group mb-2">
							...
							<input type="password" class="form-control input_pass" name="password" value="{{old('password')}}" placeholder="Enter New Password">
						</div>
